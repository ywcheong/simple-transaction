...
- 텔러 관리
    ...
    - 텔러는 두 종류로, 인간 텔러와 자동 텔러(ATM)으로 나뉜다.
        - 또한, 일반 텔러와 다르게 ATM은 자체적인 현찰을 보관하는 잔고를 가지고 있다.
            - ATM의 잔고에 있는 현찰은 은행 금고로 이동할 수 있다.
            - 은행 금고에 있는 현찰은 ATM의 잔고로 이동할 수 있다.
            - 은행 금고와 ATM의 잔고 간에 현찰이 이동할 때는 인간 텔러가 이를 보증해야 한다.
- 은행 금고 관리
    - 은행 금고는 은행이 가진 모든 현찰을 관리한다.
    - 현재 요구사항에서는 모든 텔러가 제한 없이 은행 금고에 접근할 수 있다고 가정한다.
- 일일마감
...
- 계좌 관리
    ...
    - 회원은 계좌에 현찰을 입금하거나 출금할 수 있다.
        - 입금과 출금은 특정 텔러가 보증해야만 가능하다.

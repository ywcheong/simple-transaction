...
class AccountController(
    ...
    @GetMapping("/")
    override fun lookupEveryAccounts(): ResponseEntity<LookupEveryAccountsResponse> {
        // 요청 준비 - 없음
        // 의존성 조율
    ...
    @GetMapping("/{id}")
    override fun lookupOneAccount(@PathVariable id: String): ResponseEntity<LookupOneAccountResponse> {
        // 요청 준비
    ...
    @PostMapping("/")
    override fun openNewAccount(): ResponseEntity<OpenAccountResponse> {
        // 요청 준비
    ...
    @DeleteMapping("/{id}")
    override fun closeExistingAccount(@PathVariable id: String): ResponseEntity<Nothing> {
        // 요청 준비
        val accountId = AccountId(id)
...
class TransferController(
    ...
    private val accountRepository: AccountRepository,
    private val eventRepository: AccountEventRepository,
) : TransferControllerSpec {

    @PostMapping("/")
    override fun executeTransfer(@RequestBody request: TransferRequest): ResponseEntity<TransferResponse> =
        with(request) {
            // 요청 준비
    ...
    @GetMapping("/{id}")
    override fun checkTransfer(@PathVariable id: String): ResponseEntity<CheckTransferResponse> {
        // 요청 준비
